...
from app.repositories import MedicamentoRepository, LaboratorioRepository

class MedicamentoService:
    def __init__(self, medicamento_repo: MedicamentoRepository, laboratorio_repo: LaboratorioRepository):
        self.repo = medicamento_repo
        self.laboratorio_repo = laboratorio_repo
    ...
    def crear_medicamento(self, medicamento_in: MedicamentoCreate) -> MedicamentoRead:
        ...
        if medicamento_in.ids_laboratorios:
            ...
            for lab_id in medicamento_in.ids_laboratorios:
                laboratorio = self.laboratorio_repo.get_by_id(lab_id)
                if not laboratorio:
    ...
    def actualizar(self, id: int, data: MedicamentoUpdate) -> Medicamento | None:
        ...
        datos_simples = data.model_dump(exclude={"ids_laboratorios"}, exclude_unset=True)
